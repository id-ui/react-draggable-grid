...
<Meta title="MDX/DraggableGrid" component={DraggableGrid} />

# Draggable Grid

Draggable Grid component for React

[Example](/DraggableGrid?path=/story/draggableGrid--example)

## Props

<Props of={DraggableGrid} />
